...
def showWarannty(request):
    ...
    if response.status_code == 200:
        ...
        #ในอนาคตถ้ามีการเปลี่ยนภาพพื้นหลังจะต้องมีการต่อ string เพื่อเรียกแบบบัตรรับประกันตามความต้องการ ณ ช่วงขณะนั้น
        img = "http://172.17.1.56:8001/static/assets/img/WarrantyOnlineLamina.jpg"
        # img = "http://172.17.1.56:8001/static/assets/img/WarrantyOnlineLaminaTest.jpg"
